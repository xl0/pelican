	...
	<header class="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-10">
		<div class="mx-auto max-w-7xl px-3 py-3 flex items-center justify-between">
			...
			<nav class="flex items-center gap-4">
				...
				<a href="/history" class="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">History</a>
				<a href="/gallery" class="text-sm font-medium text-primary">Gallery</a>
			</nav>
		</div>
	</header>
